...
export const Scene5BasketMatching: React.FC<Scene5Props> = ({ onComplete, stage, setStage }) => {
  // Stage 0: Given Numeral ٤, match with baskets (2, 4, 6 oranges)
  // Stage 1: Reverse Match: Given Basket with ٦ dates, choose matching numeral from [٤, ٦, ٨]
    ...
    <div className="relative w-full h-full flex flex-col justify-between overflow-hidden">
      ...
      {stage === 0 ? (
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center gap-10 z-10 px-16">
          {/* Target 3D Numeral floating proudly */}
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center gap-10 z-10 px-16">
          {/* Basket with 6 dates on the counter */}
          ...
          {/* Three 3D Playful Numerals (No large white cards!) */}
